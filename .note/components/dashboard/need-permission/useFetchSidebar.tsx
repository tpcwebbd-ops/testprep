...
// import { defaultDashboardSidebarData, getIconByIconName, IDefaultSidebarItem } from './default-items';
...
//   useEffect(() => {
//     // 1. Session Check: If no email, redirect to login
//     if (!email) {
//       router.push('/login');
//       return;
//     }
...
//   }, [email, router, allSidebarsQuery, userAccessManagementQuery, allRolesQuery, convertAPISidebarItemsToIDefaultSidebarItems]);

                          ...
                          <div className="flex justify-between mt-4">
                            {[0, 25, 50, 75, 100].map(tick => (
                              <button
                                ...
                                className={`text-[8px] font-black uppercase tracking-tighter transition-colors ${config.backgroundTransparent === tick ? 'text-indigo-400' : 'text-white/20 hover:text-white/40'}`}
                              >
                                {tick}%
                              </button>
                            ))}

  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <motion.div
        ...
        className="max-w-xs flex items-center self-center justify-between pl-2 gap-4 border border-white/10 rounded-lg w-full mx-auto mt-8 bg-white/5 backdrop-blur-md"
      >

...
export default function SearchBox({ onSearch, placeholder = 'Search...', autoFocus = false, debounceTime = 500 }: SearchBoxProps) {
  ...
  // Debounce search to avoid too many API requests while typing
  useEffect(() => {
    ...
    <div className="relative w-full mb-4">
      <div className="relative flex items-center">
        ...
        <input
          ...
          className="w-full py-2 pl-10 pr-10 border rounded-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary"
        />
        {query.length > 0 && (

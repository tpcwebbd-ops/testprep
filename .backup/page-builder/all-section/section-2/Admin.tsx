...
import { defaultData, Section2Props, ISectionData } from './data';

const AdminSection2 = ({ data }: Section2Props) => {
      ...
      <div className="max-w-6xl lg:max-w-7xl w-full">
        <div className="relative overflow-hidden rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl">
          ...
          <div className="relative p-8 lg:p-12">
            <div className="mb-8">
              <h2 className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-2">Edit Education Section</h2>
              <p className="text-gray-400">Update course section content</p>
            </div>

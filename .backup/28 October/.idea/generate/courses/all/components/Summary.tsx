...
import { useGetCoursesSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of courses data in a dialog.
...
const CoursesSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetCoursesSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Courses Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all courses data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>

...
import { useGetAssessmentsSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of assessments data in a dialog.
...
const AssessmentsSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetAssessmentsSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Assessments Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all assessments data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>

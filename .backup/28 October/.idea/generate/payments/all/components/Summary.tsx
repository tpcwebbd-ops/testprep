...
import { useGetPaymentsSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of payments data in a dialog.
...
const PaymentsSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetPaymentsSummaryQuery(
        { page, limit },
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        An overview of all payments data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>

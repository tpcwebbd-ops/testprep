...
import ViewMarketing_LeadsTable from './components/TableView'
import BulkUpdateMarketing_Leads from './components/BulkUpdate'
import BulkDynamicUpdateMarketing_Leads from './components/BulkDynamicUpdate'
...
const MainNextPage: React.FC = () => {
    ...
    const modals = [
        ...
        BulkDynamicUpdateMarketing_Leads,
    ]

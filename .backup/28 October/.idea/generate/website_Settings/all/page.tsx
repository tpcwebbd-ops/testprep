...
import ViewWebsite_SettingsTable from './components/TableView'
import BulkUpdateWebsite_Settings from './components/BulkUpdate'
import BulkDynamicUpdateWebsite_Settings from './components/BulkDynamicUpdate'
...
const MainNextPage: React.FC = () => {
    ...
    const modals = [
        ...
        BulkDynamicUpdateWebsite_Settings,
    ]

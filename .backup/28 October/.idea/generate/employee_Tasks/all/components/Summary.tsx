...
import { useGetEmployee_TasksSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of employee_Tasks data in a dialog.
 * It features a trigger button, data fetching with RTK Query,
 * and a paginated table view of monthly statistics.
 */
const Employee_TasksSummary = () => {
    const [page, setPage] = useState(1)
    const [isDialogOpen, setIsDialogOpen] = useState(false)
    const limit = 10

    const { data, isLoading, isError, isFetching } = useGetEmployee_TasksSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Employee_Tasks Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all employee_Tasks data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>
...
export default Employee_TasksSummary;

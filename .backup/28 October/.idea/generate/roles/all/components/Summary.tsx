...
import { useGetRolesSummaryQuery } from '../redux/rtk-api'
...
const RolesSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetRolesSummaryQuery(
        { page, limit },
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        An overview of all roles data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>

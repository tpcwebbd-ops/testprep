...
import { useGetBatchesSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of batches data in a dialog.
...
const BatchesSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetBatchesSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Batches Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all batches data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>

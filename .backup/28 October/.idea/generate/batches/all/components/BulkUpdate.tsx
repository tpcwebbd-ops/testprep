...
import { batchesSelectorArr } from '../store/store-constant'
                    ...
                    <div>
                        ...
                        <div className="w-full flex items-center justify-between pt-2">
                            ...
                            <Select
                                ...
                                defaultValue={
                                    (batchesSelectorArr[0] as string) || ''
                                }
                            >
                                ...
                                <SelectContent className="bg-slate-50">
                                    {batchesSelectorArr?.map((option, index) => (
                                        <SelectItem
                                            key={option + index}
                                            value={option}
                    ...
                    <div className="flex flex-col gap-2">
                        {bulkData.map((batch, idx) => (
                            ...
                            >
                                ...
                                <span className="text-blue-500">{batch['batch_title'] as string}</span>
                            </div>
                        ))}
                    </div>
                </ScrollArea>

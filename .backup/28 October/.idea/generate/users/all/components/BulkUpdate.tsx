...
import { useBulkUpdateUsersMutation } from '../redux/rtk-api'
                ...
                <ScrollArea className="h-[400px] w-full rounded-md border p-4">
                    <div className="flex flex-col gap-2">
                        {bulkData.map((user, idx) => (
                            ...
                            >
                                <span>
                                    {idx + 1}. {(user)['full_name'] as string || ''}
                                </span>
                                <span className="text-blue-500">{user['full_name'] as string}</span>
                            </div>
                        ))}
                    </div>
                </ScrollArea>

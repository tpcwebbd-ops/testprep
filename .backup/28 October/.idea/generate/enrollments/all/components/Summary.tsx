...
import { useGetEnrollmentsSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of enrollments data in a dialog.
 * It features a trigger button, data fetching with RTK Query,
 * and a paginated table view of monthly statistics.
 */
const EnrollmentsSummary = () => {
    const [page, setPage] = useState(1)
    const [isDialogOpen, setIsDialogOpen] = useState(false)
    const limit = 10

    const { data, isLoading, isError, isFetching } = useGetEnrollmentsSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Enrollments Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all enrollments data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>

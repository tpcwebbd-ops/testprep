...
import ViewRoles_Management_sTable from './components/TableView'
import BulkUpdateRoles_Management_s from './components/BulkUpdate'
import BulkDynamicUpdateRoles_Management_s from './components/BulkDynamicUpdate'
...
const MainNextPage: React.FC = () => {
    ...
    const modals = [
        ...
        BulkDynamicUpdateRoles_Management_s,
    ]

...
import ViewCompany_GoalsTable from './components/TableView'
import BulkUpdateCompany_Goals from './components/BulkUpdate'
import BulkDynamicUpdateCompany_Goals from './components/BulkDynamicUpdate'
...
const MainNextPage: React.FC = () => {
    ...
    const modals = [
        ...
        BulkDynamicUpdateCompany_Goals,
    ]

...
import { useGetCompany_GoalsSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of company_Goals data in a dialog.
 * It features a trigger button, data fetching with RTK Query,
 * and a paginated table view of monthly statistics.
 */
const Company_GoalsSummary = () => {
    const [page, setPage] = useState(1)
    const [isDialogOpen, setIsDialogOpen] = useState(false)
    const limit = 10

    const { data, isLoading, isError, isFetching } = useGetCompany_GoalsSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Company_Goals Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all company_Goals data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>
...
export default Company_GoalsSummary;

...
import { messagesSelectorArr } from '../store/store-constant'
                    ...
                    <div>
                        ...
                        <div className="w-full flex items-center justify-between pt-2">
                            ...
                            <Select
                                ...
                                defaultValue={
                                    (messagesSelectorArr[0] as string) || ''
                                }
                            >
                                ...
                                <SelectContent className="bg-slate-50">
                                    {messagesSelectorArr?.map((option, index) => (
                                        <SelectItem
                                            key={option + index}
                                            value={option}
                    ...
                    <div className="flex flex-col gap-2">
                        {bulkData.map((message, idx) => (
                            ...
                            >
                                ...
                                <span className="text-blue-500">{message['sender_Name'] as string}</span>
                            </div>
                        ))}
                    </div>
                </ScrollArea>

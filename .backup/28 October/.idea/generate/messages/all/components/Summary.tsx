...
import { useGetMessagesSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of messages data in a dialog.
...
const MessagesSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetMessagesSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Messages Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all messages data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>

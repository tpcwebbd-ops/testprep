...
import { useGetSubmissionsSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of submissions data in a dialog.
...
const SubmissionsSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetSubmissionsSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Submissions Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all submissions data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>

    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          'backdrop-blur-md bg-white/5 hover:bg-white/20 dark:bg-white/5 dark:hover:bg-white/10 border border-white/20 h-7 w-7 aria-disabled:opacity-50 p-0 select-none transition-all',

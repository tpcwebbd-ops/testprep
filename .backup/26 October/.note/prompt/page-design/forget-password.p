...
Now you have do generate a Forget-password. it has the following features.
 ...
 5. You can use two part
 6. first part is a little bit animation.
 7. in second part there are functionality for forget-password.
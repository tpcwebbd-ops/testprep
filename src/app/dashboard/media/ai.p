Look at the first ImageUploadManagerSingle.tsx 
```
'use client';
...
``` 
Now Your task is implement those instructions.
1. Copy text color and background color hover style from ImageUploadManagerSingle and implement those style in VideoUploadManagerSingle

and remember do not change other text or do not use other color or style. 
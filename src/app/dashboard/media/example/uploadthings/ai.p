look at the PdfUploadManager.tsx 
```
'use client';
...
Now please generate DocxUploadManager.tsx with the following instructions.
1. do not change color and style.
2. do not use others text only repleace Pdf to Docx.
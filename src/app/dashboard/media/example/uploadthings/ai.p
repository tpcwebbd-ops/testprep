Look at the ImageUploadManagerSingle.tsx 
```
'use client';
...
Now Your task is copy color-combination, style, text style and display text from ImageUploadManagerSingle.tsx and implement it in ImageUploadManager.tsx
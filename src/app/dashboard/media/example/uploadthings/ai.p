look at the VideoUploadManager.tsx 
```
'use client';
...
Now please generate PdfUploadManager.tsx with the following instructions.
1. do not change color and style.
2. do not use others text only repleace Video to pdf.
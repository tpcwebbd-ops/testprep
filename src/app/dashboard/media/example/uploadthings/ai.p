look at the ImageUploadManager.tsx [ImageBB]
```
'use client';
...
look at the ImageUploadManager.tsx [uploadthings]
```
'use client';
...
Now Your task is update ImageUploadManager.tsx [uploadthings] with the following instructions.
1. copy style from Imagebb and implement it in uploadthings.
2. copy color-combination and grid and implement it in uploadthings.

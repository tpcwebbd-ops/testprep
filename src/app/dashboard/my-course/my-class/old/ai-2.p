look at the url = ``` /dashboard/my-course/my-class?courseId=69df5a53d9c17d29d836ed83 ``` 

and look at the page.tsx 
```
'use client';
...
const ClassContent = () => {
  ...
  const myCourseId = searchParams.get('id');
...
Now your task is update the page with the following instructions.
1. first fetch course throw the courseID.
2. then fetch 
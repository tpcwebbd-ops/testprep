...
export default function MyCoursesPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 pt-[90px] pb-20 px-4 md:px-8 overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
              <div className="flex items-center gap-4 bg-slate-950/50 rounded-2xl p-4 border border-white/5 shadow-inner flex-1 md:flex-initial">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-emerald-400">{studentInfo.todaysAttendance}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-slate-950/50 rounded-2xl p-4 border border-white/5 shadow-inner flex-1 md:flex-initial">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-blue-400">{studentInfo.totalAttendance} Days</p>
                </div>
              </div>
            </div>
          </div>
                ...
                >
                  ...
                  <div className="mt-auto flex flex-col">
                    ...
                    <div className="px-6 pb-6 pt-2 bg-slate-950/30">
                      <Button className="w-full bg-slate-800 hover:bg-slate-700 text-white border border-white/10 rounded-xl h-12 transition-all group-hover:border-indigo-500/50 group-hover:text-indigo-300">
                        Enroll Now
                      </Button>
                    </div>
                  </div>
...
Now your task is implement those features as the follwoing instructions.
1. If No Data found then Todays Status will be in-complete, and total Attendance will be 0.
2. If I click enrolled Now then it will Open a pop-up. and it will request for course. [working api later] 

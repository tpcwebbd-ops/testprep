      ...
      <div ref={containerRef} className="flex flex-col items-center relative min-h-[500px] w-full">
        {gameLevels.length > 0 ? (
          <div className="relative w-full max-w-5xl">
            ...
            <div className="absolute left-[22px] top-4 bottom-4 w-1 bg-gradient-to-b from-violet-500/20 via-fuchsia-500/50 to-emerald-500/20 md:hidden z-0 rounded-full" />
...
Problem: When phase 1 is complete phase 2 is unlock. but the middle line highlight is not goes there. Please fix it.
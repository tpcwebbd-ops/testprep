...
and here is edit url = ''' /dashboard/courses/edit?id=69dc1ef4293d681a7431e78c ''' 


Now Your task is make a edit/page.tsx with the following instructions.
1. At the top there is a title named courses title.
2. after that at the left side there is total Number of classes. and right side there is a button called Add Class.
3. Then there are grid of classes. Each Class have options 
  - Edit [open a model and can edit (add Options)]
  - Manage resource [it will open new path (/dashboard/courses/edit?id=69dc1ef4293d681a7431e78c&class=5)]
  - delete button 
  - switch for action or deactivate
...
import { useBulkDeleteUsers_instructor_accessMutation } from '../redux/rtk-Api';
...
const BulkDeleteNextComponents: React.FC = () => {
  ...
  const [bulkDeleteUsersAccess, { isLoading }] = useBulkDeleteUsers_instructor_accessMutation();

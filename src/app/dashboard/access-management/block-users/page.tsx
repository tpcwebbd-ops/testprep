...
import { useGetUsers_block_users_accessQuery } from './redux/rtk-Api';
  ...
  let renderUI: JSX.Element = (
    <div className="container mx-auto p-4">
      <div className="flex flex-col md:flex-row gap-2 justify-between items-center mb-6">
        <h1 className="h2 w-full">Block Users Management {isSuccess && <sup className="text-xs">(total:{getResponseData?.data?.total || '00'})</sup>}</h1>

...
import { useBulkDeleteUsers_block_users_accessMutation } from '../redux/rtk-Api';
...
const BulkDeleteNextComponents: React.FC = () => {
  ...
  const [bulkDeleteUsersAccess, { isLoading }] = useBulkDeleteUsers_block_users_accessMutation();

...
const EditNextComponents: React.FC = () => {
  ...
  const handleEditRole = async () => {
    ...
    try {
      ...
      console.log('updateData : ', { _id, createdAt, updatedAt });
      await updateRoles({
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4 pr-1">
              ...
              <div className="col-span-3">
                <InputFieldForString id="name" placeholder="Name" value={editedRole['name']} onChange={value => handleFieldChange('name', value as string)} />
              </div>
            </div>
            <div className="grid grid-cols-4 items-center gap-4 pr-1">
            ...
            <div className="grid grid-cols-4 items-start gap-4 pr-1">
              ...
              <div className="col-span-3">
                <StringArrayField value={editedRole['role']} onChange={value => handleFieldChange('role', value)} />
              </div>
            </div>
          </div>
        </ScrollArea>

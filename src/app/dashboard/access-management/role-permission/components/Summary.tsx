...
import { useGetRolesSummaryQuery } from '@/redux/features/roles/rolesSlice';
...
/**
 * A component that displays a summary of roles data in a dialog.
...
const RolesSummary = () => {
  ...
  const { data, isLoading, isError } = useGetRolesSummaryQuery(
    { page, limit },
  ...
  return (
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      <DialogContent className="sm:max-w-4xl">
        <DialogHeader>
          <DialogTitle>Roles Summary</DialogTitle>
          <DialogDescription>An overview of all roles data, aggregated by month.</DialogDescription>
        </DialogHeader>

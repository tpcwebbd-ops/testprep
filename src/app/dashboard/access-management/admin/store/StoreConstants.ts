...
export const usersAccessSelectorArr = [selectUserAccess, 'admin', 'moderator', 'student', 'mentor', 'instructor', 'block'];
export type ISelectUserAccess = 'selectUserAccess' | 'admin' | 'moderator' | 'student' | 'mentor' | 'instructor' | 'block';

...
const BulkUpdateNextComponents: React.FC = () => {
    ...
    const [bulkUpdateAccessManagements, { isLoading }] =
                    ...
                    <div>
                        ...
                        <div className="w-full flex items-center justify-between pt-2">
                            ...
                            <Select
                                ...
                                defaultValue={
                                    (accessManagementsSelectorArr[0] as string) ||
                                    ''
                                }
                            >
                                ...
                                <SelectContent className="bg-slate-50">
                                    {accessManagementsSelectorArr?.map(
                                        (option, index) => (
                                            <SelectItem
                                                key={option + index}
                                                value={option}
                ...
                <ScrollArea className="h-[400px] w-full rounded-md border p-4">
                    <div className="flex flex-col gap-2">
                        {bulkData.map((accessmanagement, idx) => (
                            <div
                                key={(accessmanagement._id as string) || idx}
                            ...
                            >
                                ...
                                <span className="text-blue-500">
                                    {accessmanagement['user_name'] as string}
                                </span>
                            </div>
                        ))}
                    </div>

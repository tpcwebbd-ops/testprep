...
import { defaultPosts, IPosts } from '@/app/dashboard/posts/all/api/v1/model';
import { PostsStore } from '@/app/dashboard/posts/all/store/store-type';
import { queryParams } from '@/app/dashboard/posts/all/store/store-constant';

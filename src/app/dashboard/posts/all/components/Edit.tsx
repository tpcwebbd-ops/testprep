      ...
      <DialogContent className="sm:max-w-[625px]">
        ...
        <ScrollArea className="h-[500px] w-full rounded-md border p-4">
          <div className="grid gap-4 py-4">
            <InputField id="title" name="title" label="Title" value={editedPost['title'] || ''} onChange={handleInputChange} />
            <InputField id="books" name="books" label="Books" value={editedPost['books'] || ''} onChange={handleInputChange} />
          </div>
        </ScrollArea>
        ...
        <DialogFooter>
          ...
          <Button disabled={isLoading} onClick={handleEditPost} className="bg-green-100 text-green-600 hover:bg-green-200">

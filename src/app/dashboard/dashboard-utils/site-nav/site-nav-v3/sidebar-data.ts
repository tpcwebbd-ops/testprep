...
export const sidebarDataHome: SIDEBARTYPE[] = [
  ...
  },
  {
    ...
    content: [
      { id: 1000501, name: 'All', link: '/dashboard/finance/all', icon: iconFaCartArrowDown },
      { id: 1000502, name: 'Pending', link: '/dashboard/finance/pending', icon: iconMdShoppingCartCheckout },
      { id: 1000503, name: 'Processing', link: '/dashboard/finance/processing', icon: iconTbTruckLoading },
      { id: 1000504, name: 'Cancel', link: '/dashboard/finance/cancel', icon: iconMdRemoveShoppingCart },
      { id: 1000505, name: 'Holding', link: '/dashboard/finance/holding', icon: iconTbShoppingCartPause },
      { id: 1000506, name: 'Paid', link: '/dashboard/finance/paid', icon: iconTbShoppingCartCopy },
      { id: 1000507, name: 'Archive', link: '/dashboard/finance/archived', icon: iconTbShoppingCartBolt },
    ],
  },
  {
    id: 10006,

...
const BulkDeleteNextComponents: React.FC = () => {
  const { isBulkDeleteModalOpen, toggleBulkDeleteModal, bulkData, setBulkData } = useSessionsStore();

  const [bulkDeleteSessions, { isLoading }] = useBulkDeleteSessionsMutation();

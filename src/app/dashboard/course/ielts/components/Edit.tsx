...
import { useUpdateIELTSLecturesMutation } from '../redux/rtk-Api';
...
const EditCourse: React.FC = () => {
  ...
  const [updateCourse, { isLoading }] = useUpdateIELTSLecturesMutation();
  ...
  useEffect(() => {
    if (selectedCourses) {
      ...
      setStatus(selectedCourses.status || 'Pending');
    }
  }, [selectedCourses]);
        ...
        <ScrollArea className="h-[500px] w-full rounded-md border p-4">
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4 pr-1">
              ...
              <Select onValueChange={(value: 'Pending' | 'Private' | 'Public') => setStatus(value)} value={status}>

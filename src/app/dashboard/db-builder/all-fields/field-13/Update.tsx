...
import { field13Props, Ifield13Data } from './data';

interface UpdateProps extends field13Props {
  value?: string;
  onChange?: (value: string) => void;
}

const fallbackData: Ifield13Data = {
...
const resolveData = (data?: Ifield13Data | string): Ifield13Data => {
  if (!data) return fallbackData;
  if (typeof data === 'string') {
    try {
      return JSON.parse(data) as Ifield13Data;
    } catch {

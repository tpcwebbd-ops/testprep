...
import { useGetPagesQuery, useAddPageMutation, useUpdatePageMutation, useDeletePageMutation } from '@/redux/features/db-builder/pageBuilderSlice';
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {pages.length === 0 ? (
          <div className="animate-in fade-in zoom-in-95 duration-700 flex flex-col items-center justify-center min-h-[50vh] border-2 border-dashed border-white/10 rounded-2xl bg-white/5 backdrop-blur-sm p-12">
            ...
            <h2 className="text-3xl font-bold text-white mb-3 text-center">No DB Pages Yet</h2>

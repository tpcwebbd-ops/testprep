...
const generateClientView = async (data: string) => {
  ...
  if (isUseGenerateFolder) {
    writeInFile(mainPageTemplate, `src/app/generate/${folderName}/client-view/page.tsx`);
    writeInFile(custombuttonTemplate, `src/app/generate/${folderName}/client-view/CustomButton.tsx`);
    writeInFile(idHomeButtonTemplate, `src/app/generate/${folderName}/client-view/details/[id]/HomeButton.tsx`);
    writeInFile(detailPageTemplate, `src/app/generate/${folderName}/client-view/details/[id]/page.tsx`);
  } else {
    writeInFile(mainPageTemplate, `src/app/dashboard/${folderName}/client-view/page.tsx`);
    writeInFile(custombuttonTemplate, `src/app/dashboard/${folderName}/client-view/CustomButton.tsx`);
    writeInFile(idHomeButtonTemplate, `src/app/dashboard/${folderName}/client-view/details/[id]/HomeButton.tsx`);
    writeInFile(detailPageTemplate, `src/app/dashboard/${folderName}/client-view/details/[id]/page.tsx`);
  }
};

/*
|-----------------------------------------
| setting up GeneratePersonalDelete for the App
...
export const generateDeleteComponentFile = (inputJsonFile: string): string => {
  ...
  const mutationHookName = isPersonal ? `useDeletePersonal${singularPascalCase}Mutation` : `useDelete${pluralPascalCase}Mutation`;

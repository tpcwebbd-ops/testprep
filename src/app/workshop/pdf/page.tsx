...
const Page = () => {
  ...
  return (
    <main className="container mx-auto py-8 px-4">
      <h1 className="text-3xl font-bold mb-8">PDF Document Management</h1>
        ...
        <TabsContent value="admin" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Upload PDF files to share with clients</CardDescription>
            </CardHeader>
            <CardContent>
              <UploadButton
        ...
        <TabsContent value="client" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>View and download PDF documents</CardDescription>
            </CardHeader>
            <CardContent>

...
const ClientSection6 = ({ data }: ClientSection6Props) => {
  const sectionData = data || defaultData;

  const icons = [MessageSquare, Users, Rocket];

  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-950 via-fuchsia-950 to-violet-950 border border-violet-500/20 shadow-2xl">

...
const AdminSection6 = ({ data }: AdminSection6Props) => {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-violet-900 via-fuchsia-900 to-violet-900 flex items-center justify-center p-4">
      <div className="max-w-6xl lg:max-w-7xl w-full">
        <div className="relative overflow-hidden rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl">
          ...
          <div className="relative p-8 lg:p-12">
            <div className="mb-8">
              <h2 className="text-3xl font-bold bg-gradient-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent mb-2">Edit Community Section</h2>
              <p className="text-gray-400">Update community/platform content</p>
            </div>
            ...
            <div className="mt-8 flex justify-end">
              <Button
                ...
                className="px-8 py-3 rounded-xl bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white font-semibold hover:scale-105 transition-all duration-300 shadow-lg shadow-violet-500/30"
              >

...
import { defaultData, Section3Props, ISectionData } from './data';

const AdminSection3 = ({ data }: Section3Props) => {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-blue-900 flex items-center justify-center p-4">
      <div className="max-w-6xl lg:max-w-7xl w-full">
        <div className="relative overflow-hidden rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl">
          ...
          <div className="relative p-8 lg:p-12">
            <div className="mb-8">
              <h2 className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent mb-2">Edit Product Section</h2>
              <p className="text-gray-400">Update product/service content</p>
            </div>
            ...
            <div className="mt-8 flex justify-end">
              <Button
                ...
                className="px-8 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-semibold hover:scale-105 transition-all duration-300 shadow-lg shadow-blue-500/30"
              >

...
import { defaultData, Section5Props, ISectionData } from './data';

const AdminSection5 = ({ data }: Section5Props) => {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-emerald-900 via-teal-900 to-emerald-900 flex items-center justify-center p-4">
      <div className="max-w-6xl lg:max-w-7xl w-full">
        <div className="relative overflow-hidden rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl">
          ...
          <div className="relative p-8 lg:p-12">
            <div className="mb-8">
              <h2 className="text-3xl font-bold bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent mb-2">Edit Agency Section</h2>
              <p className="text-gray-400">Update agency/team content</p>
            </div>
            ...
            <div className="mt-8 flex justify-end">
              <Button
                ...
                className="px-8 py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-semibold hover:scale-105 transition-all duration-300 shadow-lg shadow-emerald-500/30"
              >

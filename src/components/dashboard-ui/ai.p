...
Now Your task is you have to make a pdf uploader with AudioUploadManager.tsx and AudioUploadManagerSingle.tsx 
And remember do not use others color-combination and other style. 

Now please make AudioUploadManager.tsx and AudioUploadManagerSingle.tsx with the same color-combination and other style. 
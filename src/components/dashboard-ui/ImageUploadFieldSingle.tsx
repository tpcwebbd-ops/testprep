// ImageUploadFieldSingle.tsx (Glassmorphism Enhanced)
...
export default function ImageUploadFieldSingle({ value, onChange, label = 'Profile Image', className, isProfile = false }: ImageUploadFieldSingleProps) {

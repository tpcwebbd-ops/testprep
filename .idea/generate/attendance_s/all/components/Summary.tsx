...
import { useGetAttendance_sSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of attendance_s data in a dialog.
 * It features a trigger button, data fetching with RTK Query,
 * and a paginated table view of monthly statistics.
 */
const Attendance_sSummary = () => {
    const [page, setPage] = useState(1)
    const [isDialogOpen, setIsDialogOpen] = useState(false)
    const limit = 10

    const { data, isLoading, isError, isFetching } = useGetAttendance_sSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Attendance_s Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all attendance_s data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>
...
export default Attendance_sSummary;

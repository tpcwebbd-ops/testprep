...
import ViewBatchesTable from './components/TableView'
import BulkUpdateBatches from './components/BulkUpdate'
import BulkDynamicUpdateBatches from './components/BulkDynamicUpdate'

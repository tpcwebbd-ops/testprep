...
import { profilesSelectorArr } from '../store/store-constant'
                    ...
                    <div>
                        ...
                        <div className="w-full flex items-center justify-between pt-2">
                            ...
                            <Select
                                ...
                                defaultValue={
                                    (profilesSelectorArr[0] as string) || ''
                                }
                            >
                                ...
                                <SelectContent className="bg-slate-50">
                                    {profilesSelectorArr?.map((option, index) => (
                                        <SelectItem
                                            key={option + index}
                                            value={option}
                    ...
                    <div className="flex flex-col gap-2">
                        {bulkData.map((profile, idx) => (
                            ...
                            >
                                ...
                                <span className="text-blue-500">{profile['user_id'] as string}</span>
                            </div>
                        ))}
                    </div>
                </ScrollArea>

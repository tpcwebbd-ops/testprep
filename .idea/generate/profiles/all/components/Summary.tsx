...
import { useGetProfilesSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of profiles data in a dialog.
...
const ProfilesSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetProfilesSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Profiles Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all profiles data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>

...
import { useGetUsersSummaryQuery } from '../redux/rtk-api'
...
const UsersSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetUsersSummaryQuery(
        { page, limit },
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        An overview of all users data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>

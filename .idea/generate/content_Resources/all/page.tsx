...
import ViewContent_ResourcesTable from './components/TableView'
import BulkUpdateContent_Resources from './components/BulkUpdate'
import BulkDynamicUpdateContent_Resources from './components/BulkDynamicUpdate'
...
const MainNextPage: React.FC = () => {
    ...
    const modals = [
        ...
        BulkDynamicUpdateContent_Resources,
    ]

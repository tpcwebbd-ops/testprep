...
import { useGetContent_ResourcesSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of content_Resources data in a dialog.
 * It features a trigger button, data fetching with RTK Query,
 * and a paginated table view of monthly statistics.
 */
const Content_ResourcesSummary = () => {
    const [page, setPage] = useState(1)
    const [isDialogOpen, setIsDialogOpen] = useState(false)
    const limit = 10

    const { data, isLoading, isError, isFetching } = useGetContent_ResourcesSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Content_Resources Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all content_Resources data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>
...
export default Content_ResourcesSummary;

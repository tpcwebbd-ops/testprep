...
import { useGetRewardsSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of rewards data in a dialog.
...
const RewardsSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetRewardsSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Rewards Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all rewards data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>

...
import { media_sSelectorArr } from '../store/store-constant'
                    ...
                    <div>
                        ...
                        <div className="w-full flex items-center justify-between pt-2">
                            ...
                            <Select
                                ...
                                defaultValue={
                                    (media_sSelectorArr[0] as string) || ''
                                }
                            >
                                ...
                                <SelectContent className="bg-slate-50">
                                    {media_sSelectorArr?.map((option, index) => (
                                        <SelectItem
                                            key={option + index}
                                            value={option}
                    ...
                    <div className="flex flex-col gap-2">
                        {bulkData.map((media, idx) => (
                            ...
                            >
                                ...
                                <span className="text-blue-500">{media['file_name'] as string}</span>
                            </div>
                        ))}
                    </div>
                </ScrollArea>

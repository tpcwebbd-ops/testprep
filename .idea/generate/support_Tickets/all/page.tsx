...
import ViewSupport_TicketsTable from './components/TableView'
import BulkUpdateSupport_Tickets from './components/BulkUpdate'
import BulkDynamicUpdateSupport_Tickets from './components/BulkDynamicUpdate'
...
const MainNextPage: React.FC = () => {
    ...
    const modals = [
        ...
        BulkDynamicUpdateSupport_Tickets,
    ]

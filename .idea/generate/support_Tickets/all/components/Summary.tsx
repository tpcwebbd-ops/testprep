...
import { useGetSupport_TicketsSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of support_Tickets data in a dialog.
 * It features a trigger button, data fetching with RTK Query,
 * and a paginated table view of monthly statistics.
 */
const Support_TicketsSummary = () => {
    const [page, setPage] = useState(1)
    const [isDialogOpen, setIsDialogOpen] = useState(false)
    const limit = 10

    const { data, isLoading, isError, isFetching } = useGetSupport_TicketsSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Support_Tickets Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all support_Tickets data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>
...
export default Support_TicketsSummary;

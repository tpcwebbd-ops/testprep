...
import { useGetReviewsSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of reviews data in a dialog.
...
const ReviewsSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetReviewsSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Reviews Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all reviews data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>

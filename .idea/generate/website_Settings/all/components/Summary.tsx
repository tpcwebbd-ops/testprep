...
import { useGetWebsite_SettingsSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of website_Settings data in a dialog.
 * It features a trigger button, data fetching with RTK Query,
 * and a paginated table view of monthly statistics.
 */
const Website_SettingsSummary = () => {
    const [page, setPage] = useState(1)
    const [isDialogOpen, setIsDialogOpen] = useState(false)
    const limit = 10

    const { data, isLoading, isError, isFetching } = useGetWebsite_SettingsSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Website_Settings Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all website_Settings data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>
...
export default Website_SettingsSummary;

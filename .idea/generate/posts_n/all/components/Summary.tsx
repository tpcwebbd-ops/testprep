...
import { useGetPosts_nSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of posts_n data in a dialog.
 * It features a trigger button, data fetching with RTK Query,
 * and a paginated table view of monthly statistics.
 */
const Posts_nSummary = () => {
    const [page, setPage] = useState(1)
    const [isDialogOpen, setIsDialogOpen] = useState(false)
    const limit = 10

    const { data, isLoading, isError, isFetching } = useGetPosts_nSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Posts_n Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all posts_n data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>

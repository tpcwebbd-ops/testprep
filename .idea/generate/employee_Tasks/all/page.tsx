...
import ViewEmployee_TasksTable from './components/TableView'
import BulkUpdateEmployee_Tasks from './components/BulkUpdate'
import BulkDynamicUpdateEmployee_Tasks from './components/BulkDynamicUpdate'
...
const MainNextPage: React.FC = () => {
    ...
    const modals = [
        ...
        BulkDynamicUpdateEmployee_Tasks,
    ]

...
import { useGetFollow_UpsSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of follow_Ups data in a dialog.
 * It features a trigger button, data fetching with RTK Query,
 * and a paginated table view of monthly statistics.
 */
const Follow_UpsSummary = () => {
    const [page, setPage] = useState(1)
    const [isDialogOpen, setIsDialogOpen] = useState(false)
    const limit = 10

    const { data, isLoading, isError, isFetching } = useGetFollow_UpsSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Follow_Ups Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all follow_Ups data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>
...
export default Follow_UpsSummary;

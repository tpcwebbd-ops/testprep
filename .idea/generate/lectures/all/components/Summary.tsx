...
import { useGetLecturesSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of lectures data in a dialog.
...
const LecturesSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetLecturesSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Lectures Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all lectures data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>

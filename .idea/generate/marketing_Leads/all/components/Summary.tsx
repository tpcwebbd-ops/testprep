...
import { useGetMarketing_LeadsSummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of marketing_Leads data in a dialog.
 * It features a trigger button, data fetching with RTK Query,
 * and a paginated table view of monthly statistics.
 */
const Marketing_LeadsSummary = () => {
    const [page, setPage] = useState(1)
    const [isDialogOpen, setIsDialogOpen] = useState(false)
    const limit = 10

    const { data, isLoading, isError, isFetching } = useGetMarketing_LeadsSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Marketing_Leads Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all marketing_Leads data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>
...
export default Marketing_LeadsSummary;
